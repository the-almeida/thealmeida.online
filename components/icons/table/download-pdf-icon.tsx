...
export const PdfDownloadIcon = ({
  fill = "#262626", // Cor padrão alterada para combinar com o SVG
  size,
  height,
  width,
  ...props
  ...
  return (
    <svg
      ...
      viewBox="0 0 424 511.54" // Mantendo a viewBox original do SVG
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      {...props}
    >
      <path
        fill={fill} // Usando a prop fill
        fillRule="nonzero"
      ...
      />
      <path
        fill="red" // Vermelho fixo para o círculo de download
      ...
      />
      <path
        fill="#fff" // Branco fixo para o ícone de download
        fillRule="nonzero"
